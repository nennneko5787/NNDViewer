...
void Util_expl_set_callback(void (*callback)(std::string, std::string)) { expl_callback = callback; }

void Util_expl_set_cancel_callback(void (*callback)(void)) { expl_cancel_callback = callback; }

void Util_expl_set_current_patch(std::string patch) { expl_current_patch = patch; }
