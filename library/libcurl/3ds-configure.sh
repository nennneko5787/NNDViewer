NNDVIEWER_PATH=C:/path/to/NNDViewer


LIBCTRU_PATH=$NNDVIEWER_PATH/library/libctru
LIBBROTLI_PATH=$NNDVIEWER_PATH/library/libbrotli
NGHTTP2_PATH=$NNDVIEWER_PATH/library/nghttp2
